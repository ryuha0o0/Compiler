...
static const yytype_int16 yyrline[] =
{
     ...
     229,   230,   234,   235,   239,   247,   251,   257,   264,   270,
     276,   282,   288,   294,   295,   301,   310,   311,   312,   313,
     314,   315,   321,   327,   333,   339,   345,   351,   356,   362,
     368,   378,   388,   398,   404,   410,   414,   415
};
#endif
...
#line 252 "subc.y"
      {
        if(!(yyvsp[-2].typeVal)->type || !(yyvsp[0].typeVal)->type) (yyval.typeVal)=make_ext(NULL,0);
        else if(is_numeric((yyvsp[-2].typeVal)->type) && is_numeric((yyvsp[0].typeVal)->type)) (yyval.typeVal) = make_ext(make_basic(TYPE_INT),0);
...
#line 258 "subc.y"
      {
        if(!(yyvsp[-2].typeVal)->type || !(yyvsp[0].typeVal)->type) (yyval.typeVal)=make_ext(NULL,0);
        else if((is_numeric((yyvsp[-2].typeVal)->type)&&is_numeric((yyvsp[0].typeVal)->type)) || (is_pointer((yyvsp[-2].typeVal)->type)&&is_pointer((yyvsp[0].typeVal)->type)))
...
#line 265 "subc.y"
      {
        if(!(yyvsp[-2].typeVal)->type || !(yyvsp[0].typeVal)->type) (yyval.typeVal)=make_ext(NULL,0);
        else if(is_numeric((yyvsp[-2].typeVal)->type) && is_numeric((yyvsp[0].typeVal)->type)) (yyval.typeVal) = make_ext((yyvsp[-2].typeVal)->type,0);
